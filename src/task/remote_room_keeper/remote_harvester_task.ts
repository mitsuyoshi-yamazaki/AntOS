...
export class RemoteHarvesterTask extends Task {
  ...
  public encode(): RemoteHarvesterTaskState {
    return {
      t: "RemoteHarvesterTask",
      s: this.startTime,
  ...
  public static create(roomName: RoomName, targetRoomName: RoomName, sourceId: Id<Source>): RemoteHarvesterTask {
    return new RemoteHarvesterTask(Game.time, [], roomName, targetRoomName, sourceId, null, null)
  }
