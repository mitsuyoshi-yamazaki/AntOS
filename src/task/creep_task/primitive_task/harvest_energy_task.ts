...
export type HarvestEnergyTaskFailedReason = ERR_NOT_IN_RANGE | ERR_NOT_ENOUGH_RESOURCES | ERR_BUSY | ERR_PROGRAMMING_ERROR
...
export class HarvestEnergyTask implements CreepTask<HarvestEnergyTaskFailedReason> {
  ...
  public static decode(state: HarvestEnergyTaskState): HarvestEnergyTask | CreepDecodeFailureTask {
  ...
  public run(creep: Creep): CreepTaskProgressType<HarvestEnergyTaskFailedReason> {
