...
// function shortenedNumber(num: number): string {
//   if (num < 1000) {
//     return `${num}`
//   }
//   if (num < 1000000) {
...
// function describeTime(ticks: Timestamp): string {
...
// function creepBodyColorCode(body: BodyPartConstant): string {
//   switch (body) {
//     case WORK:
//       return "#FFE76E"
//     case CARRY:
