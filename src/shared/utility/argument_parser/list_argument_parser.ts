...
import { ArgumentParsingOptions, BooleanArgument, CreepArgument, DirectionArgument, FloatArgument, IntArgument, LocalPositionArgument, LocalPositionsArgument, PowerCreepArgument, PowerTypeArgument, TypedStringArgument, RoomArgument, RoomNameArgument, RoomNameListArgument, RoomPositionArgument, SingleArgument, StringArgument, StringListArgument, VisibleRoomObjectArgument, GameObjectIdArgument } from "./string_parser"
...
interface KeywordArgumentsInterface {
  ...
  visibleGameObject(index: number, key: string, options?: ArgumentParsingOptions): SingleArgument<{ inRoomName?: RoomName }, RoomObject>
...
export class ListArguments implements KeywordArgumentsInterface {
  ...
  public gameObjectId(index: number, key: string, options?: ArgumentParsingOptions): SingleArgument<void, string> {
    return new GameObjectIdArgument(key, this.getValueAt(index, key), options)
  }

  public visibleGameObject(index: number, key: string, options?: ArgumentParsingOptions): SingleArgument<{ inRoomName?: RoomName }, RoomObject> {
    return new VisibleRoomObjectArgument(key, this.getValueAt(index, key), options)
  }
