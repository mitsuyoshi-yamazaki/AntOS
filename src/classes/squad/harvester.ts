...
export class HarvesterSquad extends Squad {
  ...
  private get_sources(): void {
    ...
    else if (this.source_info.id == '59f1c0d07d0b3d79de5f0588') { // W38S6 Lemergium
      this.resource_type = RESOURCE_LEMERGIUM
    }
    else if (this.source_info.id == '59f1c0dd7d0b3d79de5f16ae') { // E13N36 Oxygen
      this.resource_type = RESOURCE_OXYGEN
    }
    else if (this.source_info.id == '59f1c0ce7d0b3d79de5f022d') { // W48S12
      this.resource_type = RESOURCE_HYDROGEN
    }
    else if (this.source_info.id == '59f1c0dd7d0b3d79de5f16b0') { // E13N34
