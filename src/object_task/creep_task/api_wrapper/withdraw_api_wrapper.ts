...
export class WithdrawApiWrapper implements CreepApiWrapper, TargetingApiWrapper, ResourceOperationApiWrapper {
  public readonly shortDescription: string
  public readonly resourceOperationDescription = "withdraw"
