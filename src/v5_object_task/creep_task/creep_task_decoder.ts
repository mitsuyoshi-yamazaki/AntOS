...
import { FleeFromTask, FleeFromTaskState } from "./meta_task/flee_from_task"
...
class CreepTaskDecoderMap {
  ...
  "FleeFromTask" = (state: CreepTaskState) => FleeFromTask.decode(state as unknown as FleeFromTaskState)
