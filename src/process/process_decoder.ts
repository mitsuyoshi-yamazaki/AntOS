...
import { Season1143119BoostedAttackProcess, Season1143119BoostedAttackProcessState } from "./temporary/season_1143119_boosted_attack_process"
import { Season1143119LabChargerProcess, Season1143119LabChargerProcessState } from "./temporary/season_1143119_lab_charger_process"
import { Season1200082SendMineralProcess, Season1200082SendMineralProcessState } from "./temporary/season_1200082_send_mineral_process"
import { Season1244215GenericDismantleProcess, Season1244215GenericDismantleProcessState } from "./temporary/season_1244215_generic_dismantle_process"
import { Season1262745GuardRemoteRoomProcess, Season1262745GuardRemoteRoomProcessState } from "./temporary/season_1262745_guard_remote_room_process"
import { Season1349943DisturbPowerHarvestingProcess, Season1349943DisturbPowerHarvestingProcessState } from "./temporary/season_1349943_disturb_power_harvesting_process"
import { Season487837AttackInvaderCoreProcess, Season487837AttackInvaderCoreProcessState } from "./temporary/season_487837_attack_invader_core_process"
import { Season570208DismantleRcl2RoomProcess, Season570208DismantleRcl2RoomProcessState } from "./temporary/season_570208_dismantle_rcl2_room_process"
import { Season631744PowerProcessProcess, Season631744PowerProcessProcessState } from "./temporary/season_631744_power_process_process"
import { Season634603PowerCreepProcess, Season634603PowerCreepProcessState } from "./temporary/season_634603_power_creep_process"
import { Season701205PowerHarvesterSwampRunnerProcess, Season701205PowerHarvesterSwampRunnerProcessState } from "./temporary/season_701205_power_harvester_swamp_runner_process"
import { Season845677Attack1TowerProcess, Season845677Attack1TowerProcessState } from "./temporary/season_845677_attack_1tower_process"
import { Season989041MovePowerCreepProcess, Season989041MovePowerCreepProcessState } from "./temporary/season_989041_move_power_creep_process"
...
import { World35588848GclManagerProcess, World35588848GclManagerProcessState } from "./temporary/world_35588848_gcl_manager_process"
import { AllianceRequestProcess, AllianceRequestProcessState } from "./process/alliance_request_process"
...
class ProcessTypes {
  ...
  "AllianceRequestProcess" = (state: ProcessState) => AllianceRequestProcess.decode(state as unknown as AllianceRequestProcessState)
